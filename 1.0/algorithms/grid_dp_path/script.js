...
document.getElementById('algorithm_icon').innerHTML = '<img src="../../icons/algorithms/grid_dp_path.svg" width="100"/>';
document.getElementById('atitle').innerHTML = "グリッド上の動的計画法";
document.getElementById('atitle_en').innerHTML = "Dynamic Programming on Grid";
...
document.getElementById('variable').innerHTML = '<tr><th class="scene_desc" colspan="3">データ</th></tr><tr><td class="symbol"><img src="variable_P.svg" /></td><td>始点からの最短経路の数</td><td class="code">P</td></tr>';
document.getElementById('formula').innerHTML = '<tr><th class="scene_desc" colspan="3">入力</th></tr><tr><td class="symbol"><img src="formula_inp.svg" /></td><td>始点から始点までの最短経路の数を初期化します。</td><td class="code"></td></tr><tr><th class="scene_desc" colspan="3">整列</th></tr><tr><td class="symbol"><img src="formula_cur.svg" /></td><td>現在の点までの最短経路の数を、北側の点までの経路の数と西側の点までの経路の数の和とします。</td><td class="code"></td></tr><tr><th class="scene_desc" colspan="3">出力</th></tr><tr><td class="symbol"><img src="formula_outp.svg" /></td><td>始点から終点までの最短経路の数を出力します。</td><td class="code"></td></tr>';
...
document.getElementById('scene').innerHTML = '<div><p><b class="scene_desc">入力</b><br/><img src="scene_0.svg" alt="グリッド上の動的計画法 | 入力" title="グリッド上の動的計画法 | 入力"/></p></div><div><p><b class="scene_desc">整列</b><br/><img src="scene_1.svg" alt="グリッド上の動的計画法 | 整列" title="グリッド上の動的計画法 | 整列"/></p></div><div><p><b class="scene_desc">出力</b><br/><img src="scene_2.svg" alt="グリッド上の動的計画法 | 出力" title="グリッド上の動的計画法 | 出力"/></p></div>';
